...
public class MoCRenderBee extends MoCRenderInsect<MoCEntityBee, MoCModelBee> {
    ...
    private class MoCLayerBee extends LayerRenderer<MoCEntityBee, MoCModelBee> {
        public MoCLayerBee(IEntityRenderer<MoCEntityBee, MoCModelBee> entityRendererIn) {
            super(entityRendererIn);
        }

        @Override
        public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, MoCEntityBee entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
