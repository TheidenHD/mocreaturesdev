...
public class MoCModelBigCat<T extends MoCEntityBigCat> extends MoCModelAbstractBigCat<T> {
    ...
    ModelPart Stinger;
    ModelPart RightHindUpperLeg;
    ModelPart RightAnkle;
    ModelPart RightHindLowerLeg;
    ModelPart Ass;
    ModelPart TailTusk;
    ModelPart LeftChinBeard;
    ModelPart NeckBase;
    ModelPart RightEar;
    ModelPart LeftEar;
    ModelPart ForeheadHair;
    ModelPart LeftHarness;
    ModelPart RightHarness;
    ModelPart LeftUpperLip;
    ModelPart RightChinBeard;
    ModelPart LeftHindUpperLeg;
    ModelPart LeftHindLowerLeg;
    ModelPart LeftHindFoot;
    ModelPart LeftAnkle;
    ModelPart InsideMouth;
    ModelPart RightUpperLip;
    ModelPart LowerJawTeeth;
    ModelPart Nose;
    ModelPart LeftFang;
    ModelPart UpperTeeth;
    ModelPart RightFang;
    ModelPart LowerJaw;
    ModelPart SaddleFront;
    ModelPart LeftUpperLeg;
    ModelPart LeftLowerLeg;
    ModelPart LeftFrontFoot;
    ModelPart LeftClaw2;
    ModelPart LeftClaw1;
    ModelPart LeftClaw3;
    ModelPart RightClaw1;
    ModelPart RightClaw2;
    ModelPart RightClaw3;
    ModelPart RightFrontFoot;
    ModelPart RightLowerLeg;
    ModelPart RightUpperLeg;
    ModelPart Head;
    ModelPart ChinHair;
    ModelPart NeckHair;
    ModelPart Mane;
    ...
    ModelPart MidWing;
    ModelPart OuterWing;
    ModelPart InnerWingR;
    ModelPart MidWingR;
    ModelPart OuterWingR;
    ModelPart Abdomen;
    ModelPart STailRoot;
    ModelPart STail2;
    ModelPart STail3;
    ...
    ModelPart TailTip;
    ModelPart Chest;
    ModelPart SaddleBack;
    ModelPart LeftFootRing;
    ModelPart Saddle;
    ModelPart LeftFootHarness;
    ModelPart RightFootHarness;
    ModelPart RightFootRing;
    ModelPart HeadBack;
    ModelPart HarnessStick;
    ModelPart NeckHarness;
    ModelPart Collar;
    ModelPart StorageChest;
    ...
    public MoCModelBigCat() {
        ...
        this.Chest = new ModelPart(this, 0, 18);
        this.Chest.addBox(-3.5F, 0F, -8F, 7, 8, 9);
        this.Chest.setRotationPoint(0F, 8F, 0F);

        this.NeckBase = new ModelPart(this, 0, 7);
        ...
        this.Collar = new ModelPart(this, 18, 0);
        ...
        this.HeadBack = new ModelPart(this, 0, 0);
        ...
        this.NeckHarness = new ModelPart(this, 85, 32);
        ...
        this.HarnessStick = new ModelPart(this, 85, 42);
        ...
        this.LeftHarness = new ModelPart(this, 85, 32);
        ...
        this.RightHarness = new ModelPart(this, 85, 31);
        ...
        this.LeftUpperLip = new ModelPart(this, 34, 25);
        ...
        this.UpperTeeth = new ModelPart(this, 20, 7);
        ...
        this.LeftFang = new ModelPart(this, 44, 10);
        ...
        this.RightFang = new ModelPart(this, 48, 10);
        ...
        this.RightChinBeard = new ModelPart(this, 36, 10);
        ...
        this.ForeheadHair = new ModelPart(this, 88, 0);
        ...
        this.Mane = new ModelPart(this, 94, 0);
        ...
        this.RightEar = new ModelPart(this, 54, 7);
        ...
        this.LeftEar = new ModelPart(this, 54, 4);
        ...
        this.NeckHair = new ModelPart(this, 108, 17);
        ...
        this.InnerWing = new ModelPart(this, 26, 115);
        ...
        this.MidWing = new ModelPart(this, 36, 89);
        ...
        this.OuterWing = new ModelPart(this, 62, 115);
        ...
        this.InnerWingR = new ModelPart(this, 26, 102);
        ...
        this.MidWingR = new ModelPart(this, 82, 89);
        ...
        this.OuterWingR = new ModelPart(this, 62, 102);
        ...
        this.Abdomen = new ModelPart(this, 0, 35);
        ...
        this.Ass = new ModelPart(this, 0, 49);
        ...
        this.TailRoot = new ModelPart(this, 96, 83);
        ...
        this.Tail2 = new ModelPart(this, 96, 75);
        ...
        this.Tail3 = new ModelPart(this, 96, 67);
        ...
        this.Tail4 = new ModelPart(this, 96, 61);
        ...
        this.TailTip = new ModelPart(this, 96, 55);
        ...
        this.TailTusk = new ModelPart(this, 96, 49);
        ...
        this.SaddleBack = new ModelPart(this, 77, 26);
        ...
        this.LeftFootHarness = new ModelPart(this, 81, 18);
        ...
        this.LeftFootRing = new ModelPart(this, 107, 31);
        ...
        this.RightFootHarness = new ModelPart(this, 101, 18);
        ...
        this.RightFootRing = new ModelPart(this, 101, 31);
        ...
        this.StorageChest = new ModelPart(this, 32, 59);
        ...
        this.STailRoot = new ModelPart(this, 104, 79);
        ...
        this.STail2 = new ModelPart(this, 106, 69);
        ...
        this.STail3 = new ModelPart(this, 108, 60);
        ...
        this.STail4 = new ModelPart(this, 108, 51);
        ...
        this.STail5 = new ModelPart(this, 108, 42);
        ...
        this.StingerLump = new ModelPart(this, 112, 34);
        ...
        this.Stinger = new ModelPart(this, 118, 29);
        ...
        this.LeftUpperLeg = new ModelPart(this, 0, 96);
        ...
        this.LeftLowerLeg = new ModelPart(this, 0, 107);
        ...
        this.LeftFrontFoot = new ModelPart(this, 0, 116);
        ...
        this.LeftClaw1 = new ModelPart(this, 16, 125);
        ...
        this.LeftClaw2 = new ModelPart(this, 16, 125);
        ...
        this.LeftClaw3 = new ModelPart(this, 16, 125);
        ...
        this.RightUpperLeg = new ModelPart(this, 14, 96);
        ...
        this.RightLowerLeg = new ModelPart(this, 12, 107);
        ...
        this.RightFrontFoot = new ModelPart(this, 0, 122);
        ...
        this.RightClaw1 = new ModelPart(this, 16, 125);
        ...
        this.RightClaw2 = new ModelPart(this, 16, 125);
        ...
        this.RightClaw3 = new ModelPart(this, 16, 125);
        ...
        this.LeftHindUpperLeg = new ModelPart(this, 0, 67);
        ...
        this.LeftAnkle = new ModelPart(this, 0, 80);
        ...
        this.LeftHindLowerLeg = new ModelPart(this, 0, 86);
        ...
        this.LeftHindFoot = new ModelPart(this, 0, 91);
        ...
        this.RightHindUpperLeg = new ModelPart(this, 16, 67);
        ...
        this.RightAnkle = new ModelPart(this, 10, 80);
        ...
        this.RightHindLowerLeg = new ModelPart(this, 8, 86);
        ...
        this.RightHindFoot = new ModelPart(this, 12, 91);
