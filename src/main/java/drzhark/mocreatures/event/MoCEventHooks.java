...
public class MoCEventHooks {
    ...
    public void onLivingSpawnEvent(LivingSpawnEvent event) {
        MobEntity entity = event.getEntityLiving();
        Class<? extends MobEntity> entityClass = entity.getClass();
    ...
    private BlockPos getSafeSpawnPos(MobEntity entity, BlockPos near) {
        int radius = 6;
        int maxTries = 24;
        BlockPos testing;
